...
export default function PatientDashboard() {
  ...
  const patientName = patientData.name || (localStorage.getItem("clinovaLanguage") === "hindi" ? "मरीज़" : "Patient");
        ...
        actions: [
          {
            ...
            description:
              "अपने लक्षण साझा करें और निर्देशित प्रश्नों के उत्तर दें ताकि AI की सहायता से एक प्रारंभिक रिपोर्ट तैयार की जा सके।",
            icon: Stethoscope,
            route: "/care-system",
            badge: "AI सहायता",
          },
